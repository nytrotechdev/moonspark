<template>
    <li class="nav-item dropdown notification_dropdown">
        <a class="nav-link  ai-icon" href="javascript:;" data-toggle="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <div id="dlab_W_Notification1" class="widget-media dz-scroll p-3 height380 ps">
                <ul class="timeline">
                    <li v-bind:key="index" v-if="notifications && notifications.length>0" 
                        ...
                        <a @click.prevent="redirectTo(index)" href="javascript:void(0)">
                            <div class="timeline-panel">
                                <div class="media mr-2">
                                    <i class="fa fa-user icon-bg-circle bg-cyan"></i>
                                </div>
