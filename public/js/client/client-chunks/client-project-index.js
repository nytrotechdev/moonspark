...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getProjects: function getProjects() {
      ...
      axios.get("/projects?".concat(this.buildqueryparams(query))).then(function (_ref) {
        var data = _ref.data;
        _this.projects = data;
        _this.rate = _this.projects;
      });
    },
    setRate: function setRate() {
      var _this2 = this;

      axios.post("/projects/".concat(this.rate.project_id, "/set-rate"), this.rate).then(function (_ref2) {
        var data = _ref2.data;
        $('#setRate').modal('hide');
    ...
    _c("section", { staticClass: "account-container" }, [
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "wrapper" }, [
          ...
          _c("div", {
            staticClass:
              "row align-items-center justify-content-center p-4 m-4",
          }),
        ]),
      ]),
    ]),
